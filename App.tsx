...
const Home: React.FC = () => {
  ...
  return (
    <div className="space-y-12 pb-20">
      ...
      <section id="wiedza" className="container mx-auto px-4 scroll-mt-24">
        <h2 className="text-4xl font-bold text-center mb-10 text-amber-200">Podstawowe Nauki</h2>
      ...
      <section id="praktyka" className="container mx-auto px-4 scroll-mt-24">
        <h2 className="text-4xl font-bold text-center mb-10 text-amber-200">Narzędzia Praktyczne</h2>
